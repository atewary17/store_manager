# app/controllers/sales/outstanding_payments_controller.rb
# Accounts Receivable — Outstanding customer payments.
# Lists customers (debtors) who owe money on confirmed sales invoices.
class Sales::OutstandingPaymentsController < Sales::BaseController

  # GET /sales/accounting/outstanding_payments
  ...
  def index
    ...
    @outstanding_payments = by_customer.filter_map do |customer, invs|
    ...
    @outstanding_payments.sort_by! { |c| -c[:outstanding] }
  end

  # GET /sales/accounting/outstanding_payments/:id   — customer ledger
  def show
